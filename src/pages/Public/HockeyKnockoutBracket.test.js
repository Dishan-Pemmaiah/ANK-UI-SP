...
test('standard rounds appear Quarter, Semi, Final, Third with readable stacked teams and TBD slots', () => {
  ...
  render(<MemoryRouter><HockeyKnockoutBracket rounds={[{ id:'third',name:'3rd Place',sort_order:1 },{ id:'semi',name:'Semi Final',sort_order:2 },{ id:'legacy-two',name:'2',sort_order:20 },{ id:'final',name:'Final',sort_order:3 },{ id:'quarter',name:'Quter Final',sort_order:8 }]} matches={matches} teams={teams} championId="a" /></MemoryRouter>);
